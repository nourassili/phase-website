        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="font-serif text-4xl sm:text-5xl lg:text-6xl font-bold text-black leading-tight mb-6">
              ...
              <span className="text-lavender">The wellness industry hasn't caught up.</span>
            </h1>
            <p className="text-lg sm:text-xl text-dark-grey/80 mb-8 leading-relaxed">
              Phase is built for women in perimenopause and menopause who are tired of being dismissed, handed generic advice, and left to figure it out alone.
            </p>
